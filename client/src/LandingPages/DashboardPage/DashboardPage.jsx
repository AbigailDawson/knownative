        ...
        <div className="dashboard">
            <div className="dashboard side-nav">
                <div className="nav-main-container">
                    ...
                    <ul className="nav-links">
                        <li><a className="link active" href="/dashboard">Dashboard</a></li>
                        <li><a className="link" href="/">Cards</a></li>
                        <li><a className="link" href="/">Library</a></li>
                        <li><a className="link" href="/">Progress</a></li>
                        <li><a className="link" href="/">Resources</a></li>
                    </ul>
                </div>
            ...
            <div className="main-container">
                <div className="user-info">
                    <button>
                        <p>Abigail</p>
                        <img className="user-profile-picture" src="/images/square-logo.png" alt="User profile picture." />
                ...
                <div>
                    <div className="sub-container">
                        <div className="dashboard sub-content">
                            ...
                            <p className="dashboard card-body">每天我要到許多地方去，也會遇到很多人。有些人喜款叫我「左轉」、「右轉」、「停」...</p>
                        </div>
                        <button>
                            Study
                        </button>
                ...
                <div className="recently-added">
                    <div className="sub-container">
                        <div className="dashboard sub-content">
                            ...
                            <p className="dashboard card-body">信用卡雏然很方便，但是不小心的话，一下子就會花掉很多绕，所以現在還不了錢的人越来越多。…</p>
                        </div>
                        <button>
                            Study
                        </button>
