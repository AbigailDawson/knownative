    ...
    <LandingPageNav />
      <section className="intro">
        <div>
          ...
          <p className="about-body">KnowNative is a language learning web application that offers a refreshing alternative to traditional textbooks by allowing learners to gather and study their own materials in one seamless platform.</p>
          <p className="about-body">Learners of traditional Chinese who want to enhance their reading comprehension through immersive and personalized study experiences can do so with KnowNative. It's designed for those who want to fully engage with authentic language materials to gain a deeper understanding of how native speakers naturally communicate.</p>
          <p className="about-body">KnowNative empowers learners by offering a platform where they can collect, annotate, and study their own chosen texts, all within a single intuitive interface. Featuring dynamic annotations and automatically generated flashcards from any chosen words, KnowNative puts learners in charge of their language journey.</p>
        </div>
      </section>
