      ...
      <div className="dialog-padding">
        ...
        {pageCount === 1 ? (
          <div className="page-one">
            ...
            <p>
              KnowNative can help you read and study texts written in Mandarin
              Chinese.
            </p>
            <p>
              We'll help you choose a{" "}
              <span className="bolded">sample text</span> for this demo based on
              your language level. In the full version of KnowNative, you can
            ...
            <form>
              ...
              <label htmlFor="intermediateRadioButton">
                ...
                >
                  ...
                  <span>TOCFL 3-4</span>
                  <p>
                    You can conduct basic communication in daily life, study,
                    and work. You can manage most communication when traveling
                    in China.
                  </p>
                </div>
              </label>
              ...
              <label htmlFor="advancedRadioButton">
                ...
                >
                  ...
                  <span>TOCFL 5-6</span>
                  <p>
                    You can read Chinese newspapers and magazines, watch Chinese
                    films and TV shows, and can write and deliver a full speech.
                  </p>
                </div>
              </label>
            </form>
        ...
        {pageCount === 3 ? (
          <div className="page-three">
            ...
            <p>
              ...
              <span id="textChoice" className="bolded">
                {textSelection}
              </span>
              -level text.
            </p>
            <p>
              You can choose a different text at any time using the Library icon
              in the left toolbar.
            </p>
          </div>
        ) : (
        ...
        <div className="button-div">
          {pageCount === 3 ? (
            <button className="exit next" onClick={handleSubmit}>
              Let's go!
            </button>
          ) : (
            ""
